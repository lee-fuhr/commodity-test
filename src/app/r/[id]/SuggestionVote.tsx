...
export function SuggestionVote({
  ...
  return (
    <div className={`relative transition-all duration-200 ${containerStyles}`}>
      {/* Vote buttons - top right, small and subtle */}
        ...
        <button
          ...
          className={`p-1.5 rounded transition-all ${
            vote === 'up'
              ...
              : vote === 'none'
              ? 'bg-[var(--muted)] text-[var(--muted-foreground)] hover:bg-green-500/10 hover:text-green-400'
              : 'hidden'
